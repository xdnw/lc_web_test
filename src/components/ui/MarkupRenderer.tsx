...
export function markup(txt: string, opts: { replaceEmojis?: boolean } = {}): string {
...
export function Embed({json}: {json: DiscordEmbed}) {
    ...
    return (
        <div className="msgEmbed">
            <div className="markup messageContent"><MarkupRenderer content={json.content} highlight={true} /></div>
                ...
                <div className="container" key={index}>
                    <div className="embed markup">
                        <div className="embedGrid" style={{ borderColor: embed.color ? `#${embed.color.toString(16).padStart(6, "0")}` : 'transparent' }}>
                                ...
                                <div className="embedTitle embedMargin">
                                    {embed.url ? (
                                        <a className="anchor" target="_blank" href={embed.url} rel="noopener noreferrer">
                                            <MarkupRenderer content={embed.title} highlight={false} />
                                        </a>
                                    ) : (
                                        <MarkupRenderer content={embed.title} highlight={false} />
                                    )}
                            ...
                            {embed.description && <div className="embedDescription embedMargin"><MarkupRenderer content={embed.description} highlight={true} /></div>}
                            {embed.fields && (
