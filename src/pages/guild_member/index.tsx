...
import {
    BANK_ACCESS,
    MARK_ALL_READ,
    MY_AUDITS, MY_WARS, RAID, UNPROTECTED,
    UNREAD_COUNT,
...
export function RaidSection() {
    const raiding: Record<string, { endpoint: CommonEndpoint<unknown, {[key: string]: string}, {[key: string]: string}>, description: string, default_values: {[key: string]: string} }> = {
        app_7d: {
            endpoint: RAID,
            default_values: {
                nations: "*,#position<=1",
